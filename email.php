...
$count=1;
$sel_query="Select * from registrations where id=3";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr><td align="center"><?php echo $row["full_name"]; ?></td><td align="center"><?php echo $row["rfid_no"]; ?></td><td align="center"><a target="_blank" href="http://mangeerac.com/xpatrol/email2.php?id=<?php echo $row["email"]; ?>">Edit</a></td></tr>
<?php $count++; } ?>
</tbody>
</table>    
