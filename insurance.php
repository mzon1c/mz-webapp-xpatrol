...
$result = mysqli_query($con,"select count(1) FROM registrations where insurance_date<date(now())");
...
$count=1;
$sel_query="Select * from registrations where insurance_date<now() order by id";
