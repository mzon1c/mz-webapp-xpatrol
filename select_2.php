...
require 'connection.php';
 $connect = Connect();
 $output = '';  
 $sql = "SELECT sensor2.id,time(sensor2.keys1) as time,date(sensor2.keys1) as date,registrations.full_name,registrations.rfid_no,registrations.tax_date,registrations.insurance_date,registrations.pollution_date,sensor2.rfid_id FROM registrations,sensor2 where registrations.rfid_no like sensor2.rfid2";  
