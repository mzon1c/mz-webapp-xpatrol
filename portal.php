            ...
            var popupWindow=null;
                ...
                function child2_open()
                    { 
                        ...
                        popupWindow =window.open('portal_speed.php',"_blank","directories=no, status=no, menubar=no, scrollbars=yes, resizable=no,width=750, height=500,top=200,left=200",'fullscreen="yes"');
            ...
            var popupWindow=null;
                ...
                function child_open()
                    { 
                        ...
                        popupWindow =window.open('rfid.php',"_blank","directories=no, status=no, menubar=no, scrollbars=yes, resizable=no,width=1920, height=1080,top=200,left=200",'fullscreen="yes"');
...
<div class="col-md-6 col-lg-6 col-xl-3">
                                <div class="widget-bg-color-icon card-box">
                                   <a a href="" value="Submit" id="submitButton">
...
?></H4>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <iframe align="center" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3935.898418008905!2d76.54251361395379!3d9.430309285172845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b0626771413ca4d%3A0x65ae7ef65232f194!2sNH183%2C+Changanassery%2C+Kerala+686102!5e0!3m2!1sen!2sin!4v1522430674117" width="100%" height="50%" frameborder="0" style="border:0" allowfullscreen></iframe>
                                    <div class="clearfix"></div></a>
                               </div></a>
                            </div>
