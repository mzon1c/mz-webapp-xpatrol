...
<tr><td align="center"><?php echo $row["username"]; ?></td><td align="center"><?php echo $row["name"]; ?></td><td align="center"><a target="_blank" data-toggle="modal" data-target="#full-width-modal2" href="">Edit</a></td></tr>
                                        ...
                                        <div class="modal-dialog modal-full">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title mt-0">User Settings</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                </div>
                                                <div class="modal-body">

                                                    <iframe src="t_settings_edit.php?id=<?php echo $row["id"]; ?>" width="100%" height="70%">
</iframe>
