...
<tr><td align="center"><?php echo $row["username"]; ?></td><td align="center"><?php echo $row["name"]; ?></td><td align="center"><a target="_blank" href="t_settings_edit.php?id=<?php echo $row["id"]; ?>">Edit</a></td></tr>
<?php $count++; } ?>
</tbody>
</table>    
